...
const CacheKey = "web:cache"

// RememberFunc Cache-Aside schema
type RememberFunc func(ctx context.Context, container framework.Container) (any, error)
...
type Cache interface {
	...
	SetObj(ctx context.Context, key string, val any, timeout time.Duration) error
	...
	//SetForeverObj(ctx context.Context, key string, val any) error
	...
	//Remember(ctx context.Context, key string, timeout time.Duration, rememberFunc RememberFunc, model any) error
